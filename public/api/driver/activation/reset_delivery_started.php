...
try {
    ...
    if ($activation['status'] !== 'PENDING' || $activation['sent_at'] !== null) {
        $pdo->rollBack();
        driver_error(409, 'ACTIVATION_CONFLICT', 'La activación no admite revertir el inicio del envío.');
    }
    ...
    driver_error(500, 'INTERNAL_ERROR', 'No se pudo revertir el inicio del envío.');
}
